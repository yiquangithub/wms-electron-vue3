...
import { getMaterialTreeList, getMaterialList } from "@/api/baseData/material";
...
const materialCurrentNode = ref(null);
...
// 分类选择
const handleCategorySelect = (submitData) => {
  currentCategoryId.value = submitData.id;
  materialCurrentNode.value = submitData;
  currentPage.value = 1;
  loadTableData();
};
