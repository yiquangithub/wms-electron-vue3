    ...
    <el-card class="box-card header-card" shadow="never">
      <template #header>
        <div class="card-header">
          <span>
            采购合同付款计划<br /><span style="font-size: 14px; color: gray">
              跟踪合同付款进度与付款计划详情
            </span>
          </span>
      ...
      <el-descriptions :column="3" border class="contract-info">
        ...
        <el-descriptions-item label="付款日期" width="200px">
          {{ returnList?.planDate }}
        </el-descriptions-item>
        <el-descriptions-item label="支付状态" v-if="returnList">
          <div class="status-actions">
            <el-tag
              :type="
                returnList?.payStatusStr === '已付款'
                  ? 'success'
                  : returnList?.payStatusStr === '部分付款'
                  ? 'warning'
                  : 'info'
              "
            >
          ...
          >
            ...
            >
              <template #default="scope">
                <el-tag
                  :type="
                    scope.row.payStatusStr === '已付款'
                      ? 'success'
                      : scope.row.payStatusStr === '部分付款'
                      ? 'warning'
                      : 'info'
                  "
                >
      ...
      >
        ...
        >
          <template #default="scope">
            <el-tag
              :type="
                scope.row.payStatusStr === '已付款' ? 'success' : 'warning'
              "
            >
              {{ scope.row.payStatusStr }}
            </el-tag>
        ...
        <el-table-column label="付款日期" prop="actualDate" align="center" />
